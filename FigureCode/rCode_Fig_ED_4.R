...
plot(male$Froh_raw,male$pred_invlogit,ylim=c(0.8,1),xlim=xLims,xlab=expression(italic(""*H*"")[SNP]),
...
plot(female$Froh_raw,female$pred_invlogit,ylim=c(0.8,1),xlim=xLims,xlab=expression(italic(""*H*"")[SNP]),
