...
# males
plot(male$Froh_raw,male$pred_invlogit,ylim=yLims,xlim=xLims,xlab=expression(italic(""*H*"")),
...
# females
plot(female$Froh_raw,female$pred_invlogit,ylim=yLims,xlim=xLims,xlab=expression(italic(""*H*"")),
...
plot(male$Froh_raw,male$pred_invlogit,ylim=yLims,xlim=xLims,xlab=expression(italic(""*F*"")[h]),
     ylab="Male survival to 40 years",type="n",cex.lab=1.3)
...
FhMax <- (0.315-0.195)/0.315
slope <- -log((0.7799869)/(0.1875211))/FhMax
fSlope <- (0.7799869-0.1875211)/(FhMax)
hetSlope <- (0.7799869-0.1875211)/(0.314-0.196)

# females
plot(female$Froh_raw,female$pred_invlogit,ylim=yLims,xlim=xLims,xlab=expression(italic(""*F*"")[h]),
     ylab="Female survival to 40 years",type="n",cex.lab=1.3)
