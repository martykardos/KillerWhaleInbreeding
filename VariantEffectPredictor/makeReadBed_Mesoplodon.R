...
chroms <- read.table("chromSizes.Mesoplodon_europaeus_HiC.softMask_pruned.fasta",header=FALSE)
...
write.table(readBed,file="Mesoplodon_europaeus_HiC.softMask_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
