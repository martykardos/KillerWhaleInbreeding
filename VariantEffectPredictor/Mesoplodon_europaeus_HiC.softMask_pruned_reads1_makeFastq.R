inReads <- readLines("Mesoplodon_europaeus_HiC.softMask_pruned_reads1")
...
write.table(outMat,file="Mesoplodon_europaeus_HiC.softMask_pruned_reads1.fastq",quote=FALSE,col.names=FALSE,row.names=FALSE)
