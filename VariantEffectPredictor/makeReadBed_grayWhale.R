...
chroms <- read.table("chromSizes.Eschrichtius_robustus_HiC.softMask_pruned.fasta",header=FALSE)
...
write.table(readBed,file="Eschrichtius_robustus_HiC.softMask_pruned.fasta_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
