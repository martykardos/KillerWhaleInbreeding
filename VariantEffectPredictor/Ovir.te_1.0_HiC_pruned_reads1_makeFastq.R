inReads <- readLines("Ovir.te_1.0_HiC_pruned_reads1")
...
write.table(outMat,file="Ovir.te_1.0_HiC_pruned_reads1.fastq",quote=FALSE,col.names=FALSE,row.names=FALSE)
