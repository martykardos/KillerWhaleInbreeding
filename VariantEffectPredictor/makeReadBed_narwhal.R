...
chroms <- read.table("chromSizes.GCF_005190385.1_NGI_Narwhal_1_genomic_pruned.fasta",header=FALSE)
...
write.table(readBed,file="GCF_005190385.1_NGI_Narwhal_1_genomic_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
