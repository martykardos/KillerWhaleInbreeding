inReads <- readLines("Eschrichtius_robustus_HiC.softMask_pruned_reads1")
...
write.table(outMat,file="Eschrichtius_robustus_HiC.softMask_pruned_reads1.fastq",quote=FALSE,col.names=FALSE,row.names=FALSE)
