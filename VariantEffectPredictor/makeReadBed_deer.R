...
chroms <- read.table("chromSizes.Ovir.te_1.0_HiC_pruned.fasta",header=FALSE)
...
write.table(readBed,file="Ovir.te_1.0_HiC_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
