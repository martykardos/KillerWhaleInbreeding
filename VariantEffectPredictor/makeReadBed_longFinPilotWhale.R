...
chroms <- read.table("chromSizes.ASM654740v1_HiC_pruned.fasta",header=FALSE)
...
write.table(readBed,file="ASM654740v1_HiC_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
