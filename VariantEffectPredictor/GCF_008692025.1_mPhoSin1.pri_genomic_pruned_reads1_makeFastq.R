inReads <- readLines("GCF_008692025.1_mPhoSin1.pri_genomic_pruned_reads1")
...
write.table(outMat,file="GCF_008692025.1_mPhoSin1.pri_genomic_pruned_reads1.fastq",quote=FALSE,col.names=FALSE,row.names=FALSE)
