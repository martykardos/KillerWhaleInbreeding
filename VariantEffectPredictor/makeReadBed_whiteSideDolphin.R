...
chroms <- read.table("chromSizes.ASM367639v1_HiC_pruned.fasta",header=FALSE)
...
write.table(readBed,file="ASM367639v1_HiC_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
