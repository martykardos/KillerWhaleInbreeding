inReads <- readLines("Eubalaena_glacialis_HiC_pruned_reads1")
...
write.table(outMat,file="Eubalaena_glacialis_HiC_pruned_reads1.fastq",quote=FALSE,col.names=FALSE,row.names=FALSE)
