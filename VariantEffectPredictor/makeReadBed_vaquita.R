...
chroms <- read.table("chromSizes.GCF_008692025.1_mPhoSin1.pri_genomic_pruned.fasta",header=FALSE)
...
write.table(readBed,file="GCF_008692025.1_mPhoSin1.pri_genomic_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
