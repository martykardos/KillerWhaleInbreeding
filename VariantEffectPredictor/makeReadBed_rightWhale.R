...
chroms <- read.table("chromSizes.Eubalaena_glacialis_HiC_pruned.fasta",header=FALSE)
...
write.table(readBed,file="Eubalaena_glacialis_HiC_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
