inReads <- readLines("GCF_005190385.1_NGI_Narwhal_1_genomic_pruned_reads1")
...
write.table(outMat,file="GCF_005190385.1_NGI_Narwhal_1_genomic_pruned_reads1.fastq",quote=FALSE,col.names=FALSE,row.names=FALSE)
