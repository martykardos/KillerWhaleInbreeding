...
chroms <- read.table("chromSizes.ASM322739v1_HiC_pruned.fasta",header=FALSE)
...
write.table(readBed,file="ASM322739v1_HiC_pruned_read.bed",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
